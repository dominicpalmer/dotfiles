-- This code is from faimu: https://github.com/famiu/nvim-reload
local M = {}
...
function M.set_theme()
   local theme = require("common").ui.theme
   require("lib").reload_theme(theme)
end
...
function M.Restart()
   ...
   -- Source init files
   cmd "luafile ~/.config/nvim/lua/common.lua"
