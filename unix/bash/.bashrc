...
# Enable color support of ls with colour related aliases
...
# To force colour prompt, if needed
...
alias firefox="explorer.exe" # To get Firefox to run from within WSL2
alias ..='cd ..'
alias .2='cd ..; cd ..'
alias .3='cd ..; cd ..; cd ..'
alias q=exit